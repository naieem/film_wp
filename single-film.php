...
<div id="primary" class="content-area col-sm-12 col-md-8 <?php echo of_get_option('site_layout'); ?>">
	...
	?></h2>
																<h2>Genres:</h2>	<?php echo get_posts_terms('genre'); ?>
																<h2>Years:	</h2><?php echo get_posts_terms('year'); ?>
																<h2>Actors:</h2>	<?php echo get_posts_terms('actor'); ?>
																<h2>Countries:</h2>	<?php echo get_posts_terms('country'); ?>
																</div><!-- .entry-content -->
